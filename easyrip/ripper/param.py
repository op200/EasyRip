...
_PRESET__PARAM_NAME_SET: Final[dict[Preset_name, set[LiteralString]]] = {
    ...
    Preset_name.h264_amf: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.h264_nvenc: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.h264_qsv: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.hevc_amf: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.hevc_nvenc: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.hevc_qsv: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.av1_amf: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.av1_nvenc: _HW_ENCODER_PARAM_NAME_SET,
    Preset_name.av1_qsv: _HW_ENCODER_PARAM_NAME_SET,
}
...
_PRESET__DEFAULT_PARAMS: Final[
    ...
    Preset_name.x265fast4: {
        **_DEFAULT_X265_PARAMS,
        "crf": "18",
        "qpmin": "12",
        "qpmax": "28",
        "rd": "2",
